...
<div class="backgrounder flex flex-col items-center pt-10">
    ...
    <h1 class="text-3xl titlefont-bold mt-10 text-center">
    ...
    <p class="content text-center p-2">
        Our concierge would be delighted to make a reservation in any of the
        above mentioned restaurants.
    </p>
</div>
